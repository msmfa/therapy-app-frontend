...
| Account        | Account                                              | Signed-out users are asked to create an account to connect their schedule, reminder times and subscription; signed-in users are told those will be connected to their account. Note contents are said to stay on the iPhone. A summary card repeats the next session, reminder times and chosen plan with the store's price, and says Apple will ask them to confirm the trial or subscription next. | Continue with Apple / Continue with email / Already have an account? Sign in, or Continue when signed in |
